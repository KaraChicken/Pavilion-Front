...
Div.bambooLeft(id="leaf1" style="background: url('../assets/BackGround/bg2.png') no-repeat center/cover")
Div.bambooRight(style="background: url('../assets/BackGround/bg2.png') no-repeat center/cover")
Div.bambooCenterLeft(style="background: url('../assets/BackGround/bg2.png') no-repeat center/cover")
Div.bambooCenterLeft2(style="background: url('../assets/BackGround/bg2.png') no-repeat center/cover")
Div.bambooCenterRight(style="background: url('../assets/BackGround/bg2.png') no-repeat center/cover")
